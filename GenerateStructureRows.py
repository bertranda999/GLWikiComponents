...
structures: list[Structure] = [
    ...
    Structure("Scruuge Cargo Launcher", 1, 1, False, False, "(Upgraded)", mp=6, ap=3, d=4000, dp=15, acq=zone("Scruuge Perimeter"), alternatePageName="Scruuge Cargo Pad", formDescription="Upgrade with [[Scruuge Cargo Launcher]] when the Pad also had the Chamber bonus:"),
...
addAbility("Antigrav Citadel v2", {"message":"You successfully perform the upgrades.","name":"V3 Upgrade", "desc":"Upgrades Citadel to v3<br>Adds +2 Research +1 Influence<br>Planet must have at least 6 distinct structures that provide 2+ influence.<br>Costs 8 Evolution Genes", "planetEffects":[{"type":"Upgrade","new":"Antigrav Citadel v3"}], "restrictions":[{"type":"Existing Structures","statType":"ip","statMin":"2","min":"6"}],"cost":{"genes":"8"}})
addAbility("Antigrav Citadel v3", {"message":"","name":"V4 Upgrade", "desc":"Upgrades Citadel to v4<br>Adds +111 Influence Storage +11% Cloak<br>Planet must have at least 8 distinct structures that provide 2+ influence.<br>Costs 12 Evolution Genes", "planetEffects":[{"type":"Upgrade","new":"Antigrav Citadel v4"}], "restrictions":[{"type":"Existing Structures","statType":"ip","statMin":"2","min":"8"}],"cost":{"genes":"12"}})
